  ...
  return (
    <div className="w-full overflow-hidden">
      ...
      <div className="relative hidden w-full lg:block">
        ...
        <div className="animate-fade-in absolute z-20 flex w-90 items-center gap-3 rounded-2xl border bg-white/50 px-6 py-3 shadow-lg backdrop-blur-md max-xl:right-[0%] lg:top-[10%] xl:right-[5%]">
        ...
        <div className="animate-fade-in absolute top-[20%] z-20 flex w-90 items-center gap-3 rounded-2xl border bg-white/50 px-6 py-3 shadow-lg backdrop-blur-md lg:top-[30%] lg:left-[0%] xl:left-[5%]">
      ...
      {/* Video Mobile */}
      <div className="mx-auto mt-15 mb-20 h-full w-[90%] rounded-xl border shadow-2xl lg:hidden">
        <div
          className={cn(
